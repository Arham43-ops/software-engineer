            ...
            >
                ...
                >
                                ...
                                >
                                    <div className="absolute inset-0">
                                        ...
                                        <div className="absolute w-[calc(100%+100px)] h-[130vh] -top-[15vh] -left-[50px]">
                                            ...
                                            >
                                                <Image
                                                    src="/about/profile-artwork.png"
                                                    alt="Illustrated profile portrait"
                                                    fill
                    ...
                    <motion.div
                        ...
                        className="w-full max-w-[1700px] mx-auto px-8 md:px-16 lg:px-24 pt-10 md:pt-14 pb-4 md:pb-6 flex-shrink-0"
                    >
                    ...
                    <motion.div
                        style={{ opacity: textOpacity }}
                        className="w-full max-w-[1700px] mx-auto pt-4 pb-16 flex flex-col gap-6 flex-shrink-0"
                    >
                        <div className="px-8 md:px-16 lg:px-24 mb-2">
                            <h4 className="text-base md:text-lg uppercase tracking-[0.15em] font-bold text-zinc-500 dark:text-zinc-400">
